...
//
//        if let alertView = CustomAlertView.viewFromXib as? CustomAlertView {
//            alertView.showAlert(message, okTitle: okTitle ?? CBtnOk , cancleTitle: cancleTitle ?? CBtnCancel, type: type, completion: completion)
//
//            self.presentPopUp(view: alertView, shouldOutSideClick: false, type: .center, completionHandler: {
//
//
//            })
//            alertView.btnOK.touchUpInside { (sender) in
//
//                self.dismissPopUp(view: alertView, completionHandler: nil)
//                if let handler = completion {
//                    handler(true)
//                }
//            }
//            alertView.btnCancle.touchUpInside { (sender) in
//
//                self.dismissPopUp(view: alertView, completionHandler: nil)
//                if let handler = completion {
//                    handler(false)
